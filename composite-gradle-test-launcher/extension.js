...
function renderFlowReplayHtml(result) {
  ...
  *{box-sizing:border-box}html,body{height:100%;overflow:hidden}body{margin:0;background:var(--vscode-editor-background);color:var(--vscode-editor-foreground);font-family:var(--vscode-font-family)}.shell{--sidebar-width:360px;--state-height:220px;height:100vh;display:grid;grid-template-columns:var(--sidebar-width) 5px minmax(0,1fr);overflow:hidden}.sidebar{background:var(--vscode-sideBar-background);display:flex;flex-direction:column;min-width:0;overflow:hidden}.v-splitter,.h-splitter{background:var(--vscode-panel-border);position:relative;z-index:5}.v-splitter{cursor:col-resize}.h-splitter{cursor:row-resize}.v-splitter:hover,.h-splitter:hover,.v-splitter.dragging,.h-splitter.dragging{background:var(--vscode-focusBorder)}.side-head{padding:12px 14px;border-bottom:1px solid var(--vscode-panel-border);flex:0 0 auto}.side-head strong{font-size:13px}.side-head small{display:block;color:var(--vscode-descriptionForeground);margin-top:4px}.tabs{display:flex;gap:4px;margin-top:10px}.tabs button{border:0;background:transparent;color:var(--vscode-descriptionForeground);padding:5px 8px;cursor:pointer;border-radius:3px}.tabs button.active{background:var(--vscode-list-activeSelectionBackground);color:var(--vscode-list-activeSelectionForeground)}.tree{overflow:auto;min-height:0;flex:1;padding:5px 0;scrollbar-gutter:stable}.node-row,.boundary-row{width:100%;border:0;background:transparent;color:inherit;text-align:left;cursor:pointer;display:grid;align-items:center}.node-row{grid-template-columns:18px 20px 1fr;padding:8px 10px}.boundary-row{grid-template-columns:24px 1fr;padding:6px 10px 6px 30px;color:var(--vscode-descriptionForeground)}.node-row:hover,.boundary-row:hover{background:var(--vscode-list-hoverBackground)}.node-row.active,.boundary-row.active{background:var(--vscode-list-activeSelectionBackground);color:var(--vscode-list-activeSelectionForeground)}.twisty{font-size:11px}.icon{color:var(--vscode-textLink-foreground)}.label{min-width:0;font-family:var(--vscode-editor-font-family);font-size:12px}.label b{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.label small{display:block;opacity:.7;margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.summary{float:right;color:var(--vscode-descriptionForeground);font-size:10px}.children{border-left:1px solid color-mix(in srgb,var(--vscode-panel-border) 75%,transparent);margin-left:18px}.viewer{display:flex;flex-direction:column;min-width:0;min-height:0;overflow:hidden}.toolbar{display:flex;gap:8px;align-items:center;padding:10px 16px;border-bottom:1px solid var(--vscode-panel-border);background:var(--vscode-editorGroupHeader-tabsBackground);flex:0 0 auto}button{font:inherit}.toolbar button{border:1px solid var(--vscode-button-border,transparent);background:var(--vscode-button-secondaryBackground);color:var(--vscode-button-secondaryForeground);padding:5px 11px;cursor:pointer}.toolbar button.primary{background:var(--vscode-button-background);color:var(--vscode-button-foreground)}.toolbar button:disabled{opacity:.45;cursor:default}.position{margin-left:auto;color:var(--vscode-descriptionForeground)}.content{min-height:0;flex:1;display:grid;grid-template-rows:minmax(0,1fr) 5px minmax(110px,var(--state-height));overflow:hidden}.content.state-collapsed{grid-template-rows:minmax(0,1fr) 5px 36px}.code-pane{min-height:0;overflow:auto;padding:14px 18px 16px;scrollbar-gutter:stable}.current-head{display:flex;gap:18px;margin-bottom:10px;position:sticky;top:-14px;z-index:3;background:var(--vscode-editor-background);padding:10px 0 8px}.identity{min-width:0}.eyebrow{text-transform:uppercase;letter-spacing:.08em;font-size:10px;color:var(--vscode-descriptionForeground);margin-bottom:6px}.identity h1{font:600 19px/1.25 var(--vscode-editor-font-family);margin:0}.identity p{font:12px/1.4 var(--vscode-editor-font-family);color:var(--vscode-descriptionForeground);margin:5px 0 0}.meta{margin-left:auto;display:flex;gap:8px}.pill{border:1px solid var(--vscode-panel-border);border-radius:999px;padding:4px 8px;font-size:11px;color:var(--vscode-descriptionForeground)}.code-card,.state-card{border:1px solid var(--vscode-panel-border);border-radius:4px;overflow:hidden}.code-title,.state-title{display:flex;align-items:center;padding:9px 12px;border-bottom:1px solid var(--vscode-panel-border);font-size:11px;background:var(--vscode-editor-background)}.code-title{position:sticky;top:64px;z-index:2}.code-title span{margin-left:auto;color:var(--vscode-descriptionForeground)}.code{font:13px/1.6 var(--vscode-editor-font-family);padding:6px 0;overflow:auto;max-width:100%;scrollbar-gutter:stable}.line{display:grid;grid-template-columns:52px max-content;min-width:100%;padding:0 12px}.line.covered{background:color-mix(in srgb,var(--vscode-testing-iconPassed) 12%,transparent)}.line.active{background:var(--vscode-editor-lineHighlightBackground);border-left:3px solid var(--vscode-focusBorder)}.num{color:var(--vscode-editorLineNumber-foreground);text-align:right;padding-right:14px;position:sticky;left:0;background:inherit}.line.active .num{color:var(--vscode-editorLineNumber-activeForeground)}.text{white-space:pre}.state-pane{min-height:0;overflow:auto;padding:8px 18px 12px;scrollbar-gutter:stable}.state-title{cursor:pointer;position:sticky;top:0;z-index:2}.state-title:before{content:'▾';margin-right:7px}.content.state-collapsed .state-title:before{content:'▸'}.content.state-collapsed .compare-grid,.content.state-collapsed .hint{display:none}.compare-grid{display:grid;grid-template-columns:1fr 1fr 1fr;min-width:720px}.compare-grid section{padding:12px;border-right:1px solid var(--vscode-panel-border);min-width:0;overflow:auto}.compare-grid section:last-child{border-right:0}.compare-grid h3{margin:0 0 10px;font-size:10px;letter-spacing:.08em;text-transform:uppercase;color:var(--vscode-descriptionForeground)}.state-row{display:grid;grid-template-columns:minmax(80px,auto) 1fr;gap:10px;margin:6px 0;font-family:var(--vscode-editor-font-family);font-size:12px}.state-key{color:var(--vscode-textLink-foreground)}.state-value{word-break:break-word}.state-type{display:block;color:var(--vscode-descriptionForeground);font-size:10px;margin-top:2px}.changed{background:color-mix(in srgb,var(--vscode-editorWarning-foreground) 10%,transparent);padding:4px 5px;border-radius:3px}.unchanged{opacity:.7}.empty{padding:14px;color:var(--vscode-descriptionForeground);border:1px dashed var(--vscode-panel-border);border-radius:4px}.hint{margin-top:8px;color:var(--vscode-descriptionForeground);font-size:11px}kbd{border:1px solid var(--vscode-panel-border);border-radius:3px;padding:1px 4px;background:var(--vscode-keybindingLabel-background)}
  ...
  function renderTimeline(){tree.innerHTML='';events.forEach((e,i)=>{const b=document.createElement('button');b.className='boundary-row';b.dataset.event=i;b.innerHTML='<span class="icon">'+(e.event==='callsite'?'◇':e.event==='enter'?'▶':e.event==='exit'?'↩':e.event==='resume'?'←':'•')+'</span><span class="label"><b>'+simpleName(e)+'.'+e.methodName+'()</b><small>'+((e.sourceFile||'')+(e.line?':'+e.line:''))+'</small></span>';b.onclick=()=>selectEvent(e);tree.appendChild(b)});document.querySelectorAll('[data-event]').forEach(x=>x.classList.toggle('active',Number(x.dataset.event)===selectedEvent))}
